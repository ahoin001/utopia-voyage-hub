        ...
        {namesSorted.map((name, idx) => {
          ...
          return (
            <button
              ...
              className={cn(
                "friend-chip motion-press rounded-full border px-3.5 py-2 text-xs font-semibold tracking-wide font-[family-name:var(--font-section)]",
                active
                  ? "friend-chip-active border-aqua bg-aqua text-background shadow-[var(--shadow-glow-aqua)] ring-2 ring-aqua/50 ring-offset-2 ring-offset-[oklch(0.14_0.06_250)]"
