      ...
      <div className="mx-auto max-w-2xl">
        <header className="mb-10 text-center">
          ...
          <h2 className="text-4xl font-bold sm:text-5xl">
            $255<span className="text-foreground/50">/person</span>
        ...
        <div className="glass-strong p-6">
          ...
          <div className={`mt-6 rounded-2xl border border-white/10 p-4 ${verdict.bg}`}>
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className={`text-xs uppercase tracking-widest ${verdict.color}`}>Verdict</div>
        ...
        <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
          <div className="glass p-4">
            ...
            <p className="mt-1 text-sm text-foreground/85">
              If <strong>one</strong> person in a room gets the package, <strong>everyone</strong> in that room must.
            </p>
          </div>
          <div className="glass p-4">
            <div className="text-xs uppercase tracking-widest text-aqua">Allowed onboard</div>
            <p className="mt-1 text-sm text-foreground/85">
              🍷 Up to <strong>2 bottles of wine</strong> per room.
            </p>
          </div>
        </div>
      </div>
