...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Utopia Escape — Bahamas Cruise" },
      { name: "description", content: "The crew's Utopia of the Seas trip — Aug 28, 2026." },
      { name: "theme-color", content: "#0a1a3a" },
      { property: "og:title", content: "Utopia Escape — Bahamas Cruise" },
      { property: "og:description", content: "The crew's Utopia of the Seas trip — Aug 28, 2026." },
